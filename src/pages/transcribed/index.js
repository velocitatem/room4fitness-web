...
function run() {
    ...
    var exID = searchParams.get('q')
    console.warn(exID)
    
    var video = `https://fitnessscribe.s3.eu-central-1.amazonaws.com/demos/${exID}/video.mp4`
    var desc = ""
    fetch(`https://fitnessscribe.s3.eu-central-1.amazonaws.com/demos/${exID}/video.mp4.json`) 
    .then((response) => {
